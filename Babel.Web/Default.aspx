...
<body style="font-family: Times New Roman">
    ...
    <div>
        <h2>
            Enter the Babel text to be translated to English:<br />
            <asp:TextBox ID="SourceTextBox" runat="server" Height="266px" Rows="100" Width="576px" TextMode="MultiLine">/*  Babel Test Cases  */
...
/* Commnet.edu was a source of many of these examples: */</asp:TextBox>
            <br />
            <asp:Button ID="TranslateButton" runat="server" Text="Translate" OnClick="TranslateButton_Click" /></h2>
        <p>
            &nbsp;</p>
        <h2>
            Results:</h2>
        <p>
            <asp:Label ID="ResultLabel" runat="server" Height="306px" Width="585px"></asp:Label>&nbsp;</p>
